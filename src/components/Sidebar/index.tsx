      ...
      <div className="px-6 pt-8 pb-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center space-x-2.5">
            <h2 className="text-lg font-bold text-gray-900 tracking-tight">SocialCollateral AI</h2>
          </div>
          <span className="bg-gray-50 text-red-500 opacity-75 text-[10px] font-bold px-2.5 py-1 rounded-full border border-gray-100 tracking-wide flex items-center gap-1.5">
            MVP DEMO
